...
public interface UserMessageMapper {
	 ...
	 */
	int createUserMessage(UserMessage userMessage);
	 ...
	 */
	int deleteUserMessageByUserId(int userId);
	 ...
	 * @Date: 2019/11/26 1:19
	 */
	int deleteUserMessageByNickname(String nickname);
	 ...
	 */
	int updateUserMessageByUserId(int userId,UserMessage userMessage);
	 ...
	 * @Date: 2019/11/26 1:25
	 */
	UserMessage selectUserMessageByNicknaem(String nickname);
	 ...
	 */
	List<UserMessage> selectUserMessagesBySex(String sex);
