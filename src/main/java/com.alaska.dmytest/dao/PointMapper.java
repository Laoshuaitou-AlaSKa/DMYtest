...
public interface PointMapper {
	 ...
	 */
	int createPoint(@Param("point") Point point);
	 ...
	 */
	int deletePointByUserId(@Param("userId") int userId);
	 ...
	 */
	int deletePointByName(@Param("userId") int userId, @Param("name") String name);
	 ...
	 */
	int deletePointById(@Param("id") int id);
	 ...
	 */
	Point selectPointById(@Param("id") int id);
	 ...
	 */
	List<Point> selectPointsByUserId(@Param("userId") int userId);
	 ...
	 */
	List<Point> selectPointByName(@Param("userId") int userId, @Param("name") String name);
